...
export const ADMIN_NAV: SidebarRegistry = {
  ...
  "Tray Analytics":             { label: "Tray Analytics",               icon: <Container className="h-4 w-4" /> },
};
...
export const WAREHOUSE_NAV: SidebarRegistry = {
  ...
  "Tray Management":      { label: "Tray Management",        icon: <Container className="h-4 w-4" /> },
};
...
export const BRANCH_NAV: SidebarRegistry = {
  ...
  "Tray Returns":        { label: "Tray Returns",        icon: <Container className="h-4 w-4" /> },
};
